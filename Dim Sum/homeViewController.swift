...
struct dimSumData {
    ...
    init (dimSumImage: UIImage, chineseName: String, englishName: String, description: String, ingredients: [UIImage], sound: String) {
...
//        
//        let myPath = NSBundle.mainBundle().pathForResource("BBQPorkBun.aiff", ofType: nil)
//        
